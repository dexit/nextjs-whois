                      ...
                      <tbody>
                        ...
                        {data.creationDate && (
                          <tr>
                            ...
                            <td>
                              {moment(new Date(data.creationDate * 1000)).format("MM/DD/YYYY")}
                            </td>
                          </tr>
                        )}
                        {data.updatedDate && (
                        ...
                        {data.expirationDate && (
                          <tr>
                            ...
                            <td>
                              {moment(new Date(data.expirationDate * 1000)).format("MM/DD/YYYY")}
                            </td>
                          </tr>
                        )}
                        {data.expirationDate && (
                          <tr>
                            ...
                            <td>
                              {moment(new Date(data.expirationDate * 1000)).diff(
                                moment(),
                                "days"
                              )}
                            </td>
