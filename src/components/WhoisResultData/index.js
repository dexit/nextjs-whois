                      ...
                      <tbody>
                        ...
                        {data.creationDate && (
                          <tr>
                            ...
                            <td>
                              {moment(data.creationDate * 1000).format("MM/DD/YYYY")}
                            </td>
                          </tr>
                        )}
                        {data.updatedDate && (
                          <tr>
                            ...
                            <td>
                              {moment(data.updatedDate * 1000).format("MM/DD/YYYY")}
                            </td>
                          </tr>
                        )}
                        {data.expirationDate && (
                          <tr>
                            ...
                            <td>
                              {moment(data.expirationDate * 1000).format("MM/DD/YYYY")}
                            </td>
                          </tr>
                        )}
                        {data.expirationDate && (
                          <tr>
                            ...
                            <td>
                              {moment(data.expirationDate * 1000).diff(
                                moment(),
                                "days"
                              )}
                            </td>
